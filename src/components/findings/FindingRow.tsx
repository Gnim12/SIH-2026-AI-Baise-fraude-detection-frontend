  ...
  return (
    <li ref={ref} className={highlighted ? 'ring-1 ring-inset ring-hold' : undefined}>
      <button
        ...
        className={`flex w-full items-center justify-between gap-2 px-2 py-1.5 text-left text-scale-3 hover:bg-shell-700 ${
      ...
      >
        <span className="flex min-w-0 items-center gap-2">
          ...
          {!hasRegion && (
            <span className="shrink-0 text-scale-1 text-steel-400">no location</span>
          )}
        </span>
